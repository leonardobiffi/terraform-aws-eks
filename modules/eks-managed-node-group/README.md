...
| <a name="input_launch_template_tags_ignored"></a> [launch\_template\_tags\_ignored](#input\_launch\_template\_tags\_ignored) | A list of tags to ignore for the tag\_specifications of launch template created | `list(string)` | `[]` | no |
